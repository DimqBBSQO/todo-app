...
const (
	salt       = "dfsagkadl;fkgjmag"
	singingKey = "aidisfhg;sdklfhgj;oaksdjfhg;oadfgadgfdag"
...
func (s *AuthService) ParseToken(accecToken string) (int, error) {
	token, err := jwt.ParseWithClaims(accecToken, &tokenClaims{}, func(token *jwt.Token) (interface{}, error) {
